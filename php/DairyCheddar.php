        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <!--Edit HERE-->
                    <img alt = "Milk" class="img-fluid" src ="../image/DairyCheddar.jpg">  
                    <fieldset id="fieldSetProduct">
                        <!--Edit HERE-->
                        <legend class="fontLegend"> Product: Cheddar </legend>
                        <!--Edit HERE-->
                        ...
                        <p>
                            <!--Edit HERE-->
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Cheddar" aria-expanded="false"
                ...
                <div class="col-md-4">
                    <div class="bottomAdditional">
                        ...
                        <a href="/php/DairyEggs.php" >
                            <!--Edit HERE-->
                            <img  alt = "Fresh Lamb" class="img-fluid" id="imgAlsoSee" src ="'.$string.'" >
                        </a>  
                        <fieldset id="fieldSetSimilarProduct">
                            <!--Edit HERE-->
