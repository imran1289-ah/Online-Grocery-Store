        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <!--Edit HERE-->
                    <img alt = "FVBroccoli" class="img-fluid" src ="../image/FVBroccoli.jpg">  
                    <fieldset id="fieldSetProduct">
                        <!--Edit HERE-->
                        <legend class="fontLegend"> Product: Broccoli </legend>
                        <!--Edit HERE-->
                        ...
                        <p>
                            <!--Edit HERE-->
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Broccoli" aria-expanded="false"
