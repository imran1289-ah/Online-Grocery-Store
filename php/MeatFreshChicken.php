...
<html lang="en">
    <head>
        ...
        <!--Edit HERE-->
        <title> Meat-Fresh Chicken </title>
    </head>
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <!--Edit HERE-->
                    <img alt = "FVBroccoli" class="img-fluid" src ="../image/MeatFreshChicken.jpg">  
                    <fieldset id="fieldSetProduct">
                        <!--Edit HERE-->
                        <legend class="fontLegend"> Product: Chicken </legend>
                        <!--Edit HERE-->
                        ...
                        <p>
                            <!--Edit HERE-->
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Chicken" aria-expanded="false"
