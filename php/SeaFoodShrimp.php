...
<html lang="en">
    ...
    <body>
        ...
        <h4 id="availibility" style="font-family:Family;color:white;"> Shrimp Section</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <img alt = "SeaFoodShrimp" class="img-fluid" src ="../image/SeaFoodShrimp.jpg">  
                        <fieldset id="fieldSetProduct">
                            <legend style="color:white;"> Product: Shrimp </legend>
                                <label style="color:white;"> SeaFood Co. <br/></label>  
                                <br/>
                                <label style="color:white"> Per Unit <br/></label>
                                <p id="price" value="5.99"> $5.99 </p> 
                                <label style="color:white"> Select Type: </label> 
                                <br/>
                                <form>
                                <input type="radio" id="whole"  name="shrimp" value ="Whole Shrimp" checked="checked"/>  <span style="color:white;">Whole</span>
                                <input type="radio"  id ="sliced" name="shrimp" value = "Sliced Shrimp" />  <span style="color:white;">Sliced</span>
                                <input type="radio" id="cooked" name="shrimp" value ="Cooked Shrimp" />  <span style="color:white;">Cooked</span>
                </form>
                                <br/>  
                ...
                <form >
                                <input type="radio"  id ="one" name="quantity" value ="1" checked="checked" /> <span style="color:white">1</span>
                                <input type="radio" id="two" name="quantity" value ="2" /> <span style="color:white">2</span>
                                <input type="radio" id="three" name="quantity"  value ="3" /> <span style="color:white">3</span>
                </form> 

            <p>
                <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#contentId" aria-expanded="false" aria-controls="contentId" style="background-color:rgba(0, 0, 0, 0.815); width:300px; height:100px;color:rgba(255, 255, 255, 0.815);font-family:Georgia, 'Times New Roman', Times, serif;" onclick="addnormalshrimp()">
                    ADD TO CART
                </button>
            </p>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                The is the shrimp that we offer in Full Cart. Porduced by companies such as SeaFood.Co. <a href="ShrimpDescription.php" style="text-decoration: none;">Click here for more description</a>
            </div>
        </div>
    </div>
    </div>
    ...
    <!--Also see section-->
    <h4 style="float:left;color:white;font-family: fantasy;">Also See:</h4>
    <br/>
    <br/>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="bottomAdditional"> 
                <a href="../php/MeatFreshPork.php" target="_self">
                    <img  alt = "Fresh Lamb" class="img-fluid" src ="../image/MeatFreshPork.jpg" style="width:400px; height:200px;" >
                </a>
                <fieldset id="fieldSetSimilarProduct">
                <legend> Product: Fresh Pork </legend>
                <label> Industrial Meats <br/></label>  
                <br/>(per pack of 3)
                <p id="price"> $7.33 </p> 
