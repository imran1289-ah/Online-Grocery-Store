        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <!--Edit HERE-->
                    <img alt = "Lobster" class="img-fluid" src ="../image/SeaFoodLobster.jpg">  
                    <fieldset id="fieldSetProduct">
                        <!--Edit HERE-->
                        <legend class="fontLegend"> Product: Lobster </legend>
                        <!--Edit HERE-->
                        <label class="fontLabel"> SeaFood Co. <br/></label>  
                        <br/>
                        <!--Edit HERE-->
                        ...
                        <p>
                            <!--Edit HERE-->
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Lobster" aria-expanded="false"
                ...
                <div class="col-md-4">
                    <div class="bottomAdditional">
                        ...
                        <fieldset id="fieldSetSimilarProduct">
                            ...
                            <p class="center">
                                <!--Edit HERE-->
                                <button class="add-cart cart4" type="button" data-toggle="collapse" data-target="Onions" aria-expanded="false" aria-controls="contentId" >
                                    ADD TO CART
                                </button>
                            </p>
                        </fieldset>
