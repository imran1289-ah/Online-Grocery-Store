        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <img alt = "FVApples" class="img-fluid" src ="../image/FVApples.jpg">  
                    <fieldset id="fieldSetProduct">
                        <legend class="fontLegend"> Product: Apples</legend>
                        <label class="fontLabel"> Fruits&Veg Co. <br/></label>  
                        <br/>
                        <label class="fontLabel"> Per Apple </label> 
                        <p id="price"> $1.99 </p> 
                        
                        <br/> 

                        <p>
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Apples" aria-expanded="false"
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="bottomAdditional" >
                        <a href="DairyAmericanCheese.php" >
                            <img  alt = "Fresh Lamb" class="img-fluid" id="imgAlsoSee" src ="../image/DairyAmericanCheese.jpg" >
                        </a>  
                        <fieldset id="fieldSetSimilarProduct" >
                            ...
                            <p id="price"> $8.19 </p> 
                            <p class="center">
                                <button class="add-cart cart2" type="button" data-toggle="collapse" data-target="AmericanCheese" aria-expanded="false" aria-controls="contentId">
                                    ADD TO CART
                                </button>
                            </p>
                        </fieldset>
                ...
                <div class="col-md-4">
                    <div class="bottomAdditional">
                        ...
                        <fieldset id="fieldSetSimilarProduct">
                            ...
                            <p id="price"> $5.99 </p> 
                            <p class="center">
                                <button class="add-cart cart3" type="button" data-toggle="collapse" data-target="Yogurt" aria-expanded="false" aria-controls="contentId">
                                    ADD TO CART
                                </button>
                            </p>
                        </fieldset>
