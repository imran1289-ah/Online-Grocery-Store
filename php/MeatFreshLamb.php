        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <!--Edit HERE-->
                    <img alt = "FVBroccoli" class="img-fluid" src ="../image/MeatFreshLamb.jpg">  
                    <fieldset id="fieldSetProduct">
                        <!--Edit HERE-->
                        <legend class="fontLegend"> Product: Lamb </legend>
                        <!--Edit HERE-->
                        <label class="fontLabel"> Meat Your Makers <br/></label>  
                        <br/>
                        <!--Edit HERE-->
                        ...
                        <p>
                            <!--Edit HERE-->
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Lamb" aria-expanded="false"
