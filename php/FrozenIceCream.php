        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <img alt = "FrozenIceCrem" class="img-fluid" src ="../image/FrozenIceCream.jpg">  
                    <fieldset id="fieldSetProduct">
                        <legend class="fontLegend"> Product: PIce Cream</legend>
                        ...
                        <p>
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="IceCream" aria-expanded="false"
                        ...
                        <div class="dropdown">
                           ...
                           I've literally never had better ice cream than this one right here. 
                            </div>
                        </div>
                    </fieldset>
                </form>
