        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <!--Edit HERE-->
                    <img alt = "Milk" class="img-fluid" src ="../image/DairyYogurt.jpg">  
                    <fieldset id="fieldSetProduct">
                        <!--Edit HERE-->
                        <legend class="fontLegend"> Product: Yogurt </legend>
                        <!--Edit HERE-->
                        ...
                        <p>
                            <!--Edit HERE-->
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Yogurt" aria-expanded="false"
        ...
        <div class="bottom">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="bottomAdditional">
                        <!--Edit HERE-->
                        <a href="/php/DairyCheddar.php" >
                            <!--Edit HERE-->
                            <img  alt = "Fresh Lamb" class="img-fluid" id="imgAlsoSee" src ="..//image/DairyCheddar.jpg" >
                        </a>  
                        <fieldset id="fieldSetSimilarProduct">
                            <!--Edit HERE-->
                            ...
                            <p class="center">
                                <!--Edit HERE-->
                                <button class="add-cart cart3" type="button" data-toggle="collapse" data-target="Cheddar" aria-expanded="false" aria-controls="contentId">
                                    ADD TO CART
                                </button>
                            </p>
                        </fieldset>
