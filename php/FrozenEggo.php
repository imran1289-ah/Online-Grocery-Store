        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <img alt = "FrozenEggo" class="img-fluid" src ="../image/FrozenEggo.jpg">  
                    <fieldset id="fieldSetProduct">
                        <legend class="fontLegend"> Product: Eggo</legend>
                        ...
                        <p>
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Eggo" aria-expanded="false"
