    ...
    <div class="bottom">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="bottomAdditional">
                    <a href="MeatFreshBeef.php" >
                        <img  alt = "lobster" class="img-fluid"  id="imgAlsoSee" src ="../image/MeatFreshBeef.jpg" >
                    </a>  
                    <fieldset id="fieldSetSimilarProduct">
                        <legend> Product: Beef </legend>
                        <label> Meat Co. <br/></label>  
                        <br/>
                        <p id="price"> $5.75 </p> 
                        <p class="center">
                            <button class="add-cart cart4" type="button" data-toggle="collapse" data-target="Beef" aria-expanded="false" aria-controls="contentId" >
                                ADD TO CART
                            </button>
                        </p>
                    </fieldset>
            ...
            <div class="col-md-4">
                <div class="bottomAdditional">
                    <a href="MeatFreshChicken.php" >
                        <img  alt = "cod" class="img-fluid" id="imgAlsoSee" src ="../image/MeatFreshChicken.jpg" >
                    </a>  
                    <fieldset id="fieldSetSimilarProduct">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="bottomAdditional">
                    <!--Edit HERE-->
                    <a href="MeatFreshPork.php" >
                        <!--Edit HERE-->
                        <img  alt = "Salmon" class="img-fluid"  id="imgAlsoSee" src ="../image/MeatFreshPork.jpg" >
                    </a>  
                    <fieldset id="fieldSetSimilarProduct">
                        <!--Edit HERE-->
            ...
            <div class="col-md-4">
                <div class="bottomAdditional">
                    ...
                    <fieldset id="fieldSetSimilarProduct">
                        ...
                        <p class="center">
                            <!--Edit HERE-->
                            <button class="add-cart cart4" type="button" data-toggle="collapse" data-target="Sausage" aria-expanded="false" aria-controls="contentId" >
                                ADD TO CART
                            </button>
                        </p>
                    </fieldset>
