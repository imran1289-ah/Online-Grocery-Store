...
<html lang="en">
    <head>
        ...
        <!--Edit HERE-->
        <title> Meat-Fresh Sausage </title>
    </head>
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <!--Edit HERE-->
                    <img alt = "FVBroccoli" class="img-fluid" src ="../image/MeatSausage.jpg">  
                    <fieldset id="fieldSetProduct">
                        <!--Edit HERE-->
                        <legend class="fontLegend"> Product: Sausage </legend>
                        <!--Edit HERE-->
                        <label class="fontLabel"> Game Meats <br/></label>  
                        <br/>
                        <!--Edit HERE-->
                        <label class="fontLabel"> (675g) </label> 
                        <!--Edit HERE-->
                        <p id="price"> $8.99 </p> 
                        ...
                        <p>
                            <!--Edit HERE-->
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Sausage" aria-expanded="false"
