        ...
        <div class="row">
            <div class="col-md-12">
                <form id="centerFood" action="">
                    <img alt = "FrozenLasagna" class="img-fluid" src ="../image/FrozenLasagna.jpg">  
                    <fieldset id="fieldSetProduct">
                        <legend class="fontLegend"> Product: Lasagna</legend>
                        ...
                        <p>
                            <button class="add-cart cart1" type="button" data-toggle="collapse" data-target="Lasagna" aria-expanded="false"
                        ...
                        <div class="dropdown">
                            ...
                            Why not indulge yourself in the best the frozen food industry has to offer by selecting Canada's voted most likly to savour in your mouth frozen lasagna. Like they say, once you go frozen, you never go hungry!
                            </div>
                        </div>
                    </fieldset>
                </form>
                ...
                <div class="col-md-4">
                    <div class="bottomAdditional" >
                        <a href="FrozenPotato.php" >
                            <img  alt = "Potato" class="img-fluid" id="imgAlsoSee" src ="../image/FrozenPotato.jpg" >
                        </a>  
                        <fieldset id="fieldSetSimilarProduct" >
                            <legend > Product: Frozen Potatoes </legend>
                            <label> Frozen Co. <br/></label>  
                            <br/>
                            <p id="price"> $9.99 </p> 
                            <p class="center">
                                <button class="add-cart cart2" type="button" data-toggle="collapse" data-target="Potato" aria-expanded="false" aria-controls="contentId">
                                    ADD TO CART
                                </button>
                            </p>
                        </fieldset>
                ...
                <div class="col-md-4">
                    <div class="bottomAdditional">
                        <a href="FrozenIceCream.php" >
                            <img  alt = "../php/Fresh Lamb" class="img-fluid" id="imgAlsoSee" src ="../image/FrozenIceCream.jpg" >
                        </a>  
                        <fieldset id="fieldSetSimilarProduct">
                ...
                <div class="col-md-4">
                    <div class="bottomAdditional">
                        <a href="FrozenEggo.php" >
                            <img  alt = "../php/Fresh Lamb" class="img-fluid"  id="imgAlsoSee" src ="../image/FrozenEggo.jpg" >
                        </a>  
                        <fieldset id="fieldSetSimilarProduct">
